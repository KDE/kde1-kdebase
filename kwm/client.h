...
public:
  ...
  // true if the window is reparented at present. Necessary for the
  // manager to be able to ignore the syntetic unmapNotify event
  // (which is generated by the X server when a window is reparented).
  // A usual unmapNotify would cause the window to be withdrawn.
  bool         reparenting;
