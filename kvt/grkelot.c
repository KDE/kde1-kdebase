...
static char elot_xlat_acc[] = 	"65-122:182,194,216,196,184,214,195,185,186,206,202,203,204,205,188,208,81,209,211,212,200,191,87,215,190,198,91,92,93,94,95,96,220,226,248,228,221,246,227,222,223,238,234,235,236,237,252,240,113,241,243,244,232,254,242,247,253,230";
...
static char i437_xlat_uml[] =	"65-122:128,129,150,131,132,148,130,134,42,141,137,138,139,140,142,143,81,144,145,146,135,151,87,149,42,133,91,92,93,94,95,96,152,153,175,155,156,173,154,158,250,165,161,162,163,164,166,167,113,168,169,171,159,224,170,174,251,157";
...
/* 
 * currently ELOT928 and IBM437 are supported; easy to include others (not
 * recommended: stick to just these 2 if not only the ELOT one)
 */
static XLAT_TYPE xlat_type[] = {
	{ elot_xlat_plain, elot_xlat_acc, elot_xlat_uml, elot_xlat_umacc },
	{ i437_xlat_plain, i437_xlat_acc, i437_xlat_uml, i437_xlat_umacc },
};
...
void
greek_init(int greek_mode)
{
	kstate_init_all(greek_mode);
}
