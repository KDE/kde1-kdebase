...
void KBookmarkManager::read( const char *filename )
{
	...
	HTMLTokenizer *ht = new HTMLTokenizer( text );
	const char *str;
...
void KBookmarkManager::write( const char *filename )
{
	...
	stream << "<!-- Do not edit this file -->" << endl;
	stream << "<TITLE>KDE Help Bookmarks</TITLE>" << endl;

	stream << "<H1>KDE Help Bookmarks</H1>" << endl;
